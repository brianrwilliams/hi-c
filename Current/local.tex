...
\end{itemize}
\owen{I don't know how to parse this at all. What $*$-weight do the $z_i$ have? Why this weight? As written it suggests that you're picking a subcomplex of $A_d$ but I don't think that's what you mean.}
\end{dfn}

We equip this bigraded algebra with differentials in both directions.
