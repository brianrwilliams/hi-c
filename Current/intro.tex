...
\owen{I don't like this first paragraph. ``the" Kac-Moody is weird because there is not just one. Why does it take about an action of a group (and why doesn't it invoke Noether's theorem)? The second sentence seems out of place and not something that physicists would recognize.}
...
\owen{Something about determinant lines}
