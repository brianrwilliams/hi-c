...
The Kac-Moody vertex algebra, as developed in \cite{IgorKM, KacVertex, BorcherdsVertex}, is a foundational object in the study of... 
In this work, we have two independent, yet related goals:

\begin{enumerate}
\item Provide analogs of the Kac-Moody vertex algebras  using factorization algebras defined on complex manifolds;
...
\brian{I've added stuff we had from a file a while ago, not sure how much of it now fits in the introduction.}
