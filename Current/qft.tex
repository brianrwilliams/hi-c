...
For this reason, the QME is automatically solved modulo the space of functionals $\clie^*(\sG) \subset \sO(\sE \oplus \sG_d[1])$.
...
The second map applies the function $\theta : \fg^{\tensor (d+1)} \to \CC$ to the Lie algebra factor and takes the wedge product of the differential forms. 
