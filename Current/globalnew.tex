...
and similarly one can quotient $(\CC[a, b, \alpha, \beta], \delta)$ by the dg ideal generated by $b$, $\alpha$, and $\beta$. 
...
\[
(\CC[a], 0) \hookrightarrow (\Omega^{0,*}(X_{\bf q}), \dbar)
\]
...
The descended form thus provides an explicit Dolbeault representative for~$a$.
\end{eg}
