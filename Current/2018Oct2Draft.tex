...
its {\em factorization algebra of quantum currents}  is given by taking the enveloping 1-shifted $BD$   algebra of the compactly supported sections of~$L$.
\end{dfn}
...
\begin{dfn}
For a local Lie algebra $(L\to X, \ell_1,\ell_2)$, 
its {\em enveloping factorization algebra}  is given by taking the Chevalley-Eilenberg chains $C_*(\sL)$ of the compactly supported sections of~$L$.
\end{dfn}
