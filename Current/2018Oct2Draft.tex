...
We emphasize here that we mean by $\Sym(\sL[1])$ not the symmetric algebra in the purely algebraic sense, but taking into account the extra structures on sections of vector bundles (e.g., the topological vector space structure).
...
There is a quantum counterpart to this construction, using the Batalin-Vilkovisky formalism for quantization.
\owen{Now describe enveloping algebra as a BV quantization of the classical currents}
