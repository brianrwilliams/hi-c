...
We hence call $\Sym(\fg[1])$ the {\em enveloping 1-shifted Poisson algebra} of a dg Lie algebra~$\fg$.
...
We refer the reader to Section 4.4 of \cite{CG2} for the definition of the ``local cohomology" of a local Lie algebra.
