...
\begin{rmk}
A version of this result was given in~\cite{CLbcov2} for $\sA = \Omega^{0,*}(X)$, 
...
More definitive results in this direction have appeared in the program for studying the superstring theory through its holomorphic twists developed in the papers of Costello and Li in~\cite{CostelloLiSUGRA} and by Costello in~\cite{CosOmega, CosM2}. 
